...
type config_region_rule_if_account_older_than = {date: string; access: access}
[@@deriving yojson {strict= false}]

type config_region_rule_if_account_newer_than = {date: string; access: access}
[@@deriving yojson {strict= false}]

type config_region_rule_if_assured_under_age = {age: int; access: access}
[@@deriving yojson {strict= false}]

type config_region_rule_if_assured_over_age = {age: int; access: access}
[@@deriving yojson {strict= false}]

type config_region_rule_if_declared_under_age = {age: int; access: access}
[@@deriving yojson {strict= false}]

type config_region_rule_if_declared_over_age = {age: int; access: access}
[@@deriving yojson {strict= false}]

type config_region_rule_default = {access: access}
[@@deriving yojson {strict= false}]
...
type rules_item =
  ...
  | ConfigRegionRuleIfDeclaredUnderAge of
  ...
  | ConfigRegionRuleIfAccountNewerThan of
      config_region_rule_if_account_newer_than
  | ConfigRegionRuleIfAccountOlderThan of
...
let rules_item_of_yojson json =
  ...
  try
    ...
    | "app.bsky.ageassurance.defs#configRegionRuleIfDeclaredOverAge" -> (
      ...
      | Ok v ->
          Ok (ConfigRegionRuleIfDeclaredOverAge v)
      | Error e ->
          Error e )
    | "app.bsky.ageassurance.defs#configRegionRuleIfDeclaredUnderAge" -> (
      ...
      | Ok v ->
          Ok (ConfigRegionRuleIfDeclaredUnderAge v)
      | Error e ->
          Error e )
    | "app.bsky.ageassurance.defs#configRegionRuleIfAssuredOverAge" -> (
      ...
      | Ok v ->
          Ok (ConfigRegionRuleIfAssuredOverAge v)
      | Error e ->
          Error e )
    | "app.bsky.ageassurance.defs#configRegionRuleIfAssuredUnderAge" -> (
      ...
      | Ok v ->
          Ok (ConfigRegionRuleIfAssuredUnderAge v)
      | Error e ->
          Error e )
    | "app.bsky.ageassurance.defs#configRegionRuleIfAccountNewerThan" -> (
      ...
      | Ok v ->
          Ok (ConfigRegionRuleIfAccountNewerThan v)
      | Error e ->
          Error e )
    | "app.bsky.ageassurance.defs#configRegionRuleIfAccountOlderThan" -> (
      ...
      | Ok v ->
          Ok (ConfigRegionRuleIfAccountOlderThan v)
      | Error e ->
          Error e )
    | _ ->
        Ok (Unknown json)
...
let rules_item_to_yojson = function
  | ConfigRegionRuleDefault v -> (
    ...
    | `Assoc fields ->
        `Assoc
          ( ( "$type"
            , `String "app.bsky.ageassurance.defs#configRegionRuleDefault" )
          :: fields )
    | other ->
        other )
...
type config = {regions: config_region list} [@@deriving yojson {strict= false}]
